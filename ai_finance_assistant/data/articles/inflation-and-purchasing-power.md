...
source_id: inflation-and-purchasing-power
---
...
This `inflation-and-purchasing-power` entry explains `inflation and purchasing power` plainly
for newcomers.
...
- Compare two timelines (5 years vs 30 years) and list how `inflation-and-purchasing-power` framing changes urgency and risk wording.
