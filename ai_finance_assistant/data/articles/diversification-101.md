...
This `diversification-101` entry explains `diversification 101` plainly for newcomers.
...
- Compare two timelines (5 years vs 30 years) and list how `diversification-101` framing changes urgency and risk wording.
