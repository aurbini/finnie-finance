...
category: portfolio
source_id: index-funds-explained
---
...
This `index-funds-explained` entry explains `index funds explained` plainly for newcomers.
...
- Compare two timelines (5 years vs 30 years) and list how `index-funds-explained` framing changes urgency and risk wording.
