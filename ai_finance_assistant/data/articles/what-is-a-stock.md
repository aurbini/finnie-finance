...
This `what-is-a-stock` entry explains `what is a stock?` plainly for newcomers.
...
- Compare two timelines (5 years vs 30 years) and list how `what-is-a-stock` framing changes urgency and risk wording.
