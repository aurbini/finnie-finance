---
title: "Loss Aversion Basics"
category: behavioral
source_id: behavioral-loss-aversion-intro
---
...
This `behavioral-loss-aversion-intro` entry explains `loss aversion basics` plainly for
newcomers.
...
- Compare two timelines (5 years vs 30 years) and list how `behavioral-loss-aversion-intro` framing changes urgency and risk wording.
