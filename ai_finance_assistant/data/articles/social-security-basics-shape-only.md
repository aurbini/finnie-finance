---
title: "Social Security Literacy Starter"
category: retirement
source_id: social-security-basics-shape-only
---

# Social Security Literacy Starter

## Snapshot

This `social-security-basics-shape-only` entry explains `social security literacy starter`
...
- Compare two timelines (5 years vs 30 years) and list how `social-security-basics-shape-only` framing changes urgency and risk wording.
