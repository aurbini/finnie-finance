---
title: "Risk vs Reward Trade-offs"
category: portfolio
source_id: risk-vs-return-tradeoff
---
...
This `risk-vs-return-tradeoff` entry explains `risk vs reward trade-offs` plainly for
newcomers.
...
- Compare two timelines (5 years vs 30 years) and list how `risk-vs-return-tradeoff` framing changes urgency and risk wording.
